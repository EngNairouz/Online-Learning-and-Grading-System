...
<?php 
           ...
           {echo("<script>location.href = 'timeout.php';</script>");
            ...
            $qid= $_SESSION['quizid']; //quiz id
             ...
             $qr= "SELECT third,answer3 FROM quizquest WHERE quiz_id = $qid;";
...
<div class="m-4"; align="center">
  <div class="form-group row">
    <label class="col-form-label col-sm-2 pt-0" style="color:black;background-image: url('grr.png');background-size:100%;" for="inputEmail3" class="col-sm-2 col-form-label">THIRD QUESTION</label>
    <div class="col-sm-10">
  ...
  <div class="form-group row" ;align="center">
    ...
    <a class="btn btn-primary" href="seconde.php" role="button">PREVIOUS QUESTION</a>
      <button class="btn btn-primary"  type="submit">NEXT QUESTION</button>
     
     <?php $_SESSION['third']=1; ?>
    </div>
  </div>
  </div>
</form>
