...
<?php 
            ...
            $qid= $_SESSION['quizid']; //quiz id
             ...
             $qr= "SELECT fifth,answer5 FROM quizquest WHERE quiz_id = $qid;";
...
<div class="m-4"; align="center">
  <div class="form-group row">
    <label class="col-form-label col-sm-2 pt-0" style="color:black;background-image: url('grr.png');background-size:100%;" for="inputEmail3" class="col-sm-2 col-form-label">FIFTH QUESTION</label>
    <div class="col-sm-10">
  ...
  <div class="form-group row" ;align="center">
    ...
    <a class="btn btn-primary" href="forthe.php" role="button">PREVIOUS QUESTION</a>
