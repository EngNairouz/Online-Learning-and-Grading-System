...
<div class="m-4"; align="center">
  <div class="form-group row">
    <label class="col-form-label col-sm-2 pt-0" style="color:black;background-image: url('grr.png');background-size:100%;" for="inputEmail3" class="col-sm-2 col-form-label">First QUESTION</label>
    <div class="col-sm-10">
  ...
  <fieldset class="form-group">
    <div class="row">
      ...
      <div class="col-sm-10 ; form-group">
        ...
        <div class="form-check">
          <input class="form-check-input" type="radio" name="corr" id="gridRadios4" value="answer4" <?php echo $fourr ?>  >
