...
<?php       
       ...
       $qid= $_SESSION['quizid']; //quiz id
         $qr= "SELECT second,answer2 FROM quizquest WHERE quiz_id = $qid;";
...
<div class="m-4"; align="center">
  <div class="form-group row">
    <label class="col-form-label col-sm-2 pt-0" style="color:black;background-image: url('grr.png');background-size:100%;" for="inputEmail3" class="col-sm-2 col-form-label">SECOND QUESTION</label>
    <div class="col-sm-10">
    <input class="form-control" name="corr" type="text" placeholder="<?php echo $ques?>" readonly>
  ...
  <div class="form-group row" ;align="center">
    <div class="col-sm-10">
     <!-- <button type="submit"  class="btn btn-primary">السؤال التالي</button>
      <button type="submit"  class="btn btn-primary">السؤال السابق</button>-->
      <h1> <?php // echo $scoree ;?>
      </h1>
      <a class="btn btn-primary" href="quize.php" role="button">PREVIOUS QUESTION</a>
